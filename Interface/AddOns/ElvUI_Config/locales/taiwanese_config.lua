...
--Module Control
L["Are you sure you want to reset ActionBars settings?"] = "你確定要重置‘動作條’的設置嗎？"
L["Are you sure you want to reset Auras settings?"] = "你確定要重置‘光環’的設置嗎？"
L["Are you sure you want to reset Bags settings?"] = "你確定要重置‘背包’的設置嗎？"
L["Are you sure you want to reset Chat settings?"] = "你確定要重置‘聊天框’的設置嗎？"
L["Are you sure you want to reset Cooldown settings?"] = "你確定要重置‘冷卻文字’的設置嗎？"
L["Are you sure you want to reset DataBars settings?"] = "你確定要重置‘數據條’的設置嗎？"
L["Are you sure you want to reset DataTexts settings?"] = "你確定要重置‘資訊文字’的設置嗎？"
L["Are you sure you want to reset General settings?"] = "你確定要重置‘一般’的設置嗎？"
L["Are you sure you want to reset NamePlates settings?"] = "你確定要重置‘姓名版’的設置嗎？"
L["Are you sure you want to reset Tooltip settings?"] = "你確定要重置‘滑鼠提示’的設置嗎？"
L["Are you sure you want to reset UnitFrames settings?"] = "你確定要重置‘單位框架’的設置嗎？"
L["Core |cfffe7b2cElvUI|r options."] = "複製EUI設置"
L["If you have any plugins supporting this feature installed you can find them in the selection dropdown to the right."] = "如果你有一個支持此功能的插件將會出現在此下拉裏."
L["Module Control"] = "模組控制"
L["Module Copy"] = "模組複製"
L["Module Reset"] = "模組重置"
L["Movers"] = "定位"
L["On screen positions for different elements."] = "不同的元素在螢幕上的位置"
L["Select a profile to copy from/to."] = "選擇一個配置用來複製或被複製."
L["This section will allow you to copy settings to a select module from or to a different profile."] = "此選項將允許你複製選擇的模組設置從或到一個配置裏."
L["This section will help reset specfic settings back to default."] = "這部分將幫助你重置特定設置為默認."

--NamePlates
L["nameplateTargetIndicator"] = "EUI默認箭頭"
L["Icon Width Override"] = "圖示寬度複寫"
L["If not set to 0 then set the width of the Aura Icon to this"] = "如果不是0,將設置圖示寬度為此值."
