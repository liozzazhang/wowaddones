...
local find, gsub, sub, format = string.find, string.gsub, string.sub, string.format
--WoW API / Variables
...
function UF:Initialize()
	...
	if (not E.private["unitframe"]["disabledBlizzardFrames"].party) and (not E.private["unitframe"]["disabledBlizzardFrames"].raid) and E.RaidUtility then
