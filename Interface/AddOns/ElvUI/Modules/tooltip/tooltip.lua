...
function TT:ShowInspectInfo(tt, unit, r, g, b)
	...
	if(inspectCache[unitGUID] and inspectCache[unitGUID].age and (GetTime() - inspectCache[unitGUID].age) < inspectAge) then
		tt:AddDoubleLine(L["Current Talent"], inspectCache[unitGUID].talent, nil, nil, nil, r, g, b)
		tt:AddDoubleLine(L["AvgItemLvl"], inspectCache[unitGUID].itemLevel, nil, nil, nil, 1, 1, 1)
